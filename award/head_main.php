...
include_once(G5_PATH.'/head.sub_main.php');
...
<div id="wrapper">
    ...
    <div id="container">
        ...
        <?php if (!defined("_INDEX_")) { ?><h2 id="container_title"><span title="<?php echo get_text($g5['title']); ?>"><?php echo get_head_title($g5['title']); ?>
        </span></h2><?php }
